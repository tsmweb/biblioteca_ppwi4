...
function verificarSenhas() {
	...
	var contraSenhaError = $("#confirmeSenhaError");
...
function contraSenhaStrength(password) {
	...
	$(".js-confirmeSenhaTamanho").removeClass(descClass[score - 1]).addClass(
			descClass[score]).css("width", desc[score]);
	$("#confirmeSenha_text").html(msg[score]);
